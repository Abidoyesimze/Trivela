...
export interface Client {
   ...
   */
  claim: ({user, amount}: {user: string, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  credit: ({from, user, amount}: {from: string, user: string, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  redeem: ({user, points_amount}: {user: string, points_amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a balance transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the current points balance for a user.
   */
  balance: ({user}: {user: string}, options?: MethodOptions) => Promise<AssembledTransaction<u64>>
   ...
   */
  migrate: ({admin, target_version}: {admin: string, target_version: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u32>>>
   ...
   */
  snapshot: ({admin, snapshot_id}: {admin: string, snapshot_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  set_tiers: ({admin, campaign_id, tiers}: {admin: string, campaign_id: u64, tiers: Array<readonly [u64, u64]>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a initialize transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Initialize the rewards contract (admin).
   */
  initialize: ({admin, name, symbol}: {admin: string, name: string, symbol: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  clear_tiers: ({admin, campaign_id}: {admin: string, campaign_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  batch_credit: ({from, recipients}: {from: string, recipients: Array<readonly [string, u64]>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  claim_vested: ({user, vest_id, amount}: {user: string, vest_id: u64, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  fund_reserve: ({from, amount}: {from: string, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_snapshot: ({snapshot_id}: {snapshot_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Option<u64>>>
   ...
   */
  total_vested: ({user}: {user: string}, options?: MethodOptions) => Promise<AssembledTransaction<u64>>
   ...
   */
  credit_vested: ({from, user, total_amount, start_ledger, end_ledger}: {from: string, user: string, total_amount: u64, start_ledger: u32, end_ledger: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  propose_admin: ({current_admin, new_admin}: {current_admin: string, new_admin: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  admin_transfer: ({admin, from, to, amount}: {admin: string, from: string, to: string, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  credit_by_rank: ({from, user, rank, campaign_id}: {from: string, user: string, rank: u64, campaign_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  list_snapshots: (options?: MethodOptions) => Promise<AssembledTransaction<Array<readonly [u64, u64]>>>
   ...
   */
  vested_balance: ({user}: {user: string}, options?: MethodOptions) => Promise<AssembledTransaction<u64>>
   ...
   */
  redemption_rate: (options?: MethodOptions) => Promise<AssembledTransaction<Option<readonly [string, u32]>>>
   ...
   */
  withdraw_reserve: ({admin, nonce, amount}: {admin: string, nonce: i128, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  credit_call_count: ({caller}: {caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  get_tier_for_rank: ({rank, campaign_id}: {rank: u64, campaign_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<u64>>
   ...
   */
  campaign_multiplier: ({campaign_id}: {campaign_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  credit_for_campaign: ({from, user, campaign_id, base_amount}: {from: string, user: string, campaign_id: u64, base_amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  set_redemption_rate: ({admin, nonce, asset, rate_bps}: {admin: string, nonce: i128, asset: string, rate_bps: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  cancel_admin_transfer: ({current_admin}: {current_admin: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_credit_rate_limit: (options?: MethodOptions) => Promise<AssembledTransaction<readonly [u32, u32]>>
   ...
   */
  set_credit_rate_limit: ({admin, max_calls, window_ledgers}: {admin: string, max_calls: u32, window_ledgers: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  set_campaign_multiplier: ({admin, campaign_id, multiplier_bps}: {admin: string, campaign_id: u64, multiplier_bps: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  set_max_credit_per_call: ({admin, max_amount}: {admin: string, max_amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
