...
export interface Client {
   ...
   */
  register: ({participant, leaf, proof, referrer}: {participant: string, leaf: Buffer, proof: Array<Buffer>, referrer: Option<string>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<boolean>>>
   ...
   */
  deregister: ({participant}: {participant: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<boolean>>>
   ...
   */
  set_active: ({admin, nonce, active}: {admin: string, nonce: u64, active: boolean}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  set_window: ({admin, nonce, start, end}: {admin: string, nonce: u64, start: u64, end: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  referrer_of: ({participant}: {participant: string}, options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
   ...
   */
  set_max_cap: ({admin, nonce, max_cap}: {admin: string, nonce: u64, max_cap: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  is_participant: ({participant}: {participant: string}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
   ...
   */
  referral_count: ({referrer}: {referrer: string}, options?: MethodOptions) => Promise<AssembledTransaction<u64>>
   ...
   */
  set_merkle_root: ({admin, nonce, root}: {admin: string, nonce: u64, root: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  admin_deregister: ({admin, nonce, participant}: {admin: string, nonce: u64, participant: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<boolean>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
